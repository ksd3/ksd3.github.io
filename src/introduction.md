...
<div style="display: flex; flex-wrap: wrap; padding: 20px 0;">
    <div style="flex: 1; margin: 10px; min-width: 200px;">
        <a href="https://drive.google.com/file/d/1ScjGbLad2LgeTUjJhX4Oes1wsF5oMnro/view?usp=sharing" style="display: block; padding: 10px; margin-bottom: 10px; text-decoration: none; background-color: #f8f9fa; text-align: center; border: 1px solid #dee2e6; border-radius: 4px; transition: background-color 0.3s ease;">
            My Resume
        </a>
        ...
        <a href="https://drive.google.com/file/d/1ErrNLNR__kXQm8GVmJxAJg-RFaOyhR0k/view?usp=sharing" style="display: block; padding: 10px; margin-bottom: 10px; text-decoration: none; background-color: #f8f9fa; text-align: center; border: 1px solid #dee2e6; border-radius: 4px; transition: background-color 0.3s ease;">
            My Academic CV
        </a>
    </div>
</div>
...
On the theory side, I'm broadly interested in astrophysics and the application of inverse methods to astrophysical phenomena. I hope to branch out into more applied [SciML](https://sciml.ai/) and develop faster and more reliable methods to understand these phenomena.
...
7. **(COEP, 2021):** Some [linear models](https://ieeexplore.ieee.org/document/9587892/) for solar power, advised by [Suhas Kakade](https://www.linkedin.com/in/suhas-kakade-a6691721/?originalSubdomain=in) and [Rohan Kulkarni](https://in.linkedin.com/in/rohan-kulkarni-35951566).
